...
O _X-Card_ cria um tom específico na mesa. Ele diz _"Estamos todos aqui juntos. Se você disser **pare**, a gente para. As pessoas que estão participando aqui são mais importantes que o jogo".
...
As pessoas normalmente acham que usar o _X-Card_ para editar tanto conteúdo que pode provocar gatilhos quanto simplesmente coisas desconfortáveis ou que não se encaicem na ideia do jogo pode resultar em reduzir o poder do _X-Card  quando ele realmente for necessário, não apenas um mal-compreendido.
...
Muitas pessoas odeiam a idéia de jogar usando o _X-Card  porque eles temem que isso possa suprimir sua criatividade. As pessoas que conduzem jogos podem se sentir especificamente ameaçadas, em especial se elas tem determinadas histórias em mente.
...
### O _X-Card  cria um ambiente de jogo 100% seguro?
